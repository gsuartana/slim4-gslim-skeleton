...
class MakeService extends Command
{
    ...
    {
        $className = MakeHelper::setClassName($input->getArgument('classname'), "Service");
        ...
        try {
            list(
                ...
                $fileName
                    ...
                    $className,
                    'src/App' . DIRECTORY_SEPARATOR . 'Services'
                );
        } catch (Exception $e) {
        ...
        // service
        $text = file_get_contents(__DIR__.'/Templates/service.template.tpl');
